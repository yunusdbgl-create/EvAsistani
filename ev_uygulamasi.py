...
def sayfa_ana_ekran():
    ...
    with tab2:
        ...
        TUM_ISLER = sorted(list(set(VARSAYILAN_IS) | kayitli_is))
        TUM_ISLER.append("✏️ Yeni Kategori Yaz")
        ...
        for kat in is_listesi:
            if kat == "Genel":
                items = df_todo[(df_todo["Durum"] == "0") & ((df_todo["Mesaj"] == "") | (df_todo["Mesaj"] == "Genel") | (df_todo["Mesaj"] == "None"))]
            else:
