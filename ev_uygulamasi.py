...
# 2. KISIM: CSS (SAF STİL - HATA OLMAMASI İÇİN AYRI YAZILDI)
st.markdown("""
<style>
    ...
    /* SATIRLARI YAN YANA TUTMA GARANTİSİ */
    ...
    /* BUTON SÜTUNLARI (ORTA VE SAĞ) - SABİT GENİŞLİK */
